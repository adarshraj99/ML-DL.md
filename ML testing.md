...
For <span style="color: blue;">contineous data prediction.</span> like house prices, stock prices, customer behaviour. These learn to predict numbers out of infinitely possible numbers. Some common types are: 
* Linear regression
